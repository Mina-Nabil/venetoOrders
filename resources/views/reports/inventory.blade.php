                ...
                <table id="myTable" class="table color-bordered-table table-striped full-color-table full-info-table hover-table" data-display-length='-1' data-order="[]">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($detailed)
                            <td>{{$row->total36 == '' ? 0 : $row->total36}}</td>
                            <td>{{$row->total38 == '' ? 0 : $row->total38}}</td>
                            <td>{{$row->total40 == '' ? 0 : $row->total40}}</td>
                            <td>{{$row->total42 == '' ? 0 : $row->total42}}</td>
                            <td>{{$row->total44 == '' ? 0 : $row->total44}}</td>
