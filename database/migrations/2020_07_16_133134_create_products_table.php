...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->foreignId("PROD_PIMG_ID")->constrained("prod_images"); // main image
            $table->foreignId("PROD_SZCT_ID")->constrained("size_chart"); // size chart image showing the size details
